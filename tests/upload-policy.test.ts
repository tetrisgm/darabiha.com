...
describe("upload policy", () => {
  it("accepts the known Darabi family ZIP", () => {
  ...
  it("keeps useful recursive files and ignores macOS metadata", () => {
    expect(isUsefulArchivePath("Darabi/tree/person.html")).toBe(true);
    expect(isUsefulArchivePath("Darabi/photos/family.jpg")).toBe(true);
    expect(isUsefulArchivePath("Darabi/source/notes.docx")).toBe(true);
    expect(isUsefulArchivePath("__MACOSX/Darabi/._person.html")).toBe(false);
    expect(isUsefulArchivePath("Darabi/.DS_Store")).toBe(false);
    expect(isUsefulArchivePath("Darabi/program.exe")).toBe(false);
  });

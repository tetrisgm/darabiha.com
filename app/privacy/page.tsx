    ...
    <main className="settings-page">
      ...
      <section className="settings-panel legal-page">
        ...
        <div className="settings-card">
          ...
          <h2>Your choices</h2>
          <p>You can disconnect a linked sign-in yourself on the <Link href="/settings">settings page</Link>. To correct or remove information about you, contact the site owner at ramine@ramine.net.</p>
        </div>
      </section>
    </main>
  );

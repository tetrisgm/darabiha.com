    ...
    <main className="settings-page">
      ...
      <section className="settings-panel legal-page">
        ...
        <div className="settings-card">
          ...
          <p>When an editor asks the archivist a question or uploads unstructured material, the relevant message, file, and current family-tree context are sent to OpenAI to extract the facts the editor requested. Structured GEDCOM files are parsed by Darabiha first. Uploaded originals remain private evidence in Cloudflare storage; public visitors cannot open source documents. Darabiha asks OpenAI not to retain these requests for product training.</p>

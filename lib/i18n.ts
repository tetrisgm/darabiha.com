...
const en: Dict = {
  ...
  "nav.account": "Account menu", "nav.home": "Go to the Family view",
...
const fa: Dict = {
  ...
  "nav.account": "منوی حساب", "nav.home": "رفتن به نمای خانواده",
...
const fr: Dict = {
  ...
  "nav.account": "Menu du compte", "nav.home": "Aller à la vue Famille",
  ...
  "family.siblings": "Frères et sœurs",

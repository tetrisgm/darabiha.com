...
const en: Dict = {
  ...
  "chat.attach": "Add files or a folder", "chat.addFiles": "Add files", "chat.addFolder": "Add a folder",
  "chat.collapse": "Collapse family chat", "chat.reveal": "Show family chat",
  "chat.title": "The Darabiha family tree",
  ...
  "family.moreRelatives": "{n} more relatives - click to see them", "family.previewing": "Previewing {name} - click to open", "family.siblings": "Siblings",
  ...
  "person.lives": "Lives in", "person.lived": "Lived in", "person.residencePlaceholder": "add a city or country",
  "person.notLiving": "Correct this - mark as living",
...
const fa: Dict = {
  ...
  "chat.attach": "افزودن پرونده یا پوشه", "chat.addFiles": "افزودن پرونده", "chat.addFolder": "افزودن پوشه",
  "chat.collapse": "بستن گفت‌وگو", "chat.reveal": "نمایش گفت‌وگو",
  "chat.title": "شجره‌نامه‌ی خاندان دارابی",
  ...
  "family.moreRelatives": "{n} خویشاوند دیگر - برای دیدن کلیک کنید", "family.previewing": "پیش‌نمایش {name} - برای باز کردن کلیک کنید", "family.siblings": "خواهر و برادر",
  ...
  "person.lives": "محل زندگی", "person.lived": "محل زندگی پیشین", "person.residencePlaceholder": "شهر یا کشور را بنویسید",
  "person.notLiving": "اصلاح - در قید حیات است",
...
const fr: Dict = {
  ...
  "chat.attach": "Ajouter des fichiers ou un dossier", "chat.addFiles": "Ajouter des fichiers", "chat.addFolder": "Ajouter un dossier",
  "chat.collapse": "Réduire la conversation", "chat.reveal": "Afficher la conversation",
  "chat.title": "L’arbre généalogique des Darabiha",
  ...
  "family.moreRelatives": "{n} autres proches - cliquez pour les voir", "family.previewing": "Aperçu de {name} - cliquez pour ouvrir", "family.siblings": "Frères et sœurs",
  ...
  "person.lives": "Habite à", "person.lived": "A habité à", "person.residencePlaceholder": "ajouter une ville ou un pays",
  "person.notLiving": "Corriger - toujours en vie",
